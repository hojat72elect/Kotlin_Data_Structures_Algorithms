...
public class SJFScheduling {
    protected ArrayList<algorithms.entities.ProcessDetails> processes;
     ...
     */
    SJFScheduling(final ArrayList<algorithms.entities.ProcessDetails> processes) {
    ...
    protected void sortByArrivalTime() {
        ...
        int i;
        int j;
        algorithms.entities.ProcessDetails temp;
        for (i = 0; i < size; i++) {
    ...
    public void scheduleProcesses() {
        ArrayList<algorithms.entities.ProcessDetails> ready = new ArrayList<>();
        ...
        int j;
        int k = 0;
        algorithms.entities.ProcessDetails running;
     ...
     * processes.
     */
    private algorithms.entities.ProcessDetails findShortestJob(ArrayList<algorithms.entities.ProcessDetails> readyProcesses) {
